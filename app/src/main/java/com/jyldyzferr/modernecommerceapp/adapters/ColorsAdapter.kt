...
import com.jyldyzferr.modernecommerceapp.databinding.ColorRvItemBinding

class ColorsAdapter : Adapter<ColorsAdapter.ColorsViewHolder>() {
    ...
    override fun onBindViewHolder(
        holder: ColorsAdapter.ColorsViewHolder,
        position: Int
    ) {
